/*
 *  SpringUtilities in org.jpws.front.util
 *  file: SpringUtilities.java
 * 
 *  Project Jpws-Front
...
public class SpringUtilities
{
    ...
    * <code>parent</code> in a grid. Each component in
	 * a column is as wide as the maximum preferred width of the components in 
    * that column; height is similarly determined for each
         ...
         int initialX, int initialY, int xPad, int yPad )
	{
		...
		for ( int c = 0; c < cols; c++ )
		{
			...
			x = Spring.sum( x, Spring.sum( width, Spring.constant( 
               c+1 == cols ? 0 : xPad ) ) );
		}
		...
		for ( int r = 0; r < rows; r++ )
		{
			...
			y = Spring.sum( y, Spring.sum( height, Spring.constant( 
               r+1 == rows ? 0 : yPad ) ) );
		}
